...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    # 新增显示名称：图像拼接多输入节点
    "ImageConcatMultiMs": "ImageConcatMulti by ms",
    "ImageBatchAccumulator": "ImageBatchAccumulator by ms",
    "AnyBatchAccumulator": "AnyBatchAccumulator by ms",
    "AnyBatchListConverter": "AnyBatchListConverter by ms",
